...
export const PurseView: FC<{}> = props =>
{
    ...
    return (
        <Column alignItems="end" className="nitro-purse-container holo-classic-purse-container" gap={ 1 }>
            <Flex alignItems="stretch" className="nitro-purse holo-classic-purse">
                <Column justifyContent="center" className="holo-purse-currencies" gap={ 1 }>
                    <CurrencyView type={ -1 } amount={ purse.credits } short={ currencyDisplayNumberShort } />
                    { getCurrencyElements(0, 2) }
                </Column>

                { !hcDisabled &&
                    <Column center pointer className="holo-purse-club" gap={ 1 } onClick={ event => CreateLinkEvent('habboUI/open/hccenter') }>
                        <LayoutCurrencyIcon type="hc" />
                        <Text variant="white" small bold>{ getClubText }</Text>
                    </Column> }

                <Column justifyContent="center" className="holo-purse-actions" gap={ 1 }>
                    <Flex center pointer className="holo-purse-action holo-purse-help" onClick={ event => CreateLinkEvent('help/show') }>
                        <i className="icon icon-help" />
                    </Flex>
                    <Flex center pointer className="holo-purse-action holo-purse-settings" onClick={ event => CreateLinkEvent('user-settings/toggle') }>
                        <i className="icon icon-cog" />
                    </Flex>
                </Column>
            </Flex>

            <Column className="holo-purse-seasonal" gap={ 1 }>
