...
export class CombatGridParser implements IMessageParser {
    ...
    public parse(wrapper: IMessageDataWrapper): boolean {
        ...
        CombatGridManager.tiles = newTiles;
        return true;
    }
    public get tiles() { return this._tiles; }
}

export class CombatGridEvent extends MessageEvent {
    constructor(callBack: Function) { super(callBack, CombatGridParser); }
    public getParser(): CombatGridParser { return super.getParser() as CombatGridParser; }
}
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.INVENTARIO_SUBASTAS, InventarioSubastasEvent);
        this._events.set(IncomingHeader.RESULTADO_PONER_SUBASTA, ResultadoPonerSubastaEvent);
        this._events.set(IncomingHeader.MIS_SUBASTAS, MisSubastasEvent);
        this._events.set(IncomingHeader.RESULTADO_RETIRAR_SUBASTA, ResultadoRetirarSubastaEvent);
        this._events.set(IncomingHeader.RESULTADO_PUJA_SUBASTA, ResultadoPujaSubastaEvent);
        this._events.set(IncomingHeader.ESTADO_SESION_SUBASTAS, EstadoSesionSubastasEvent);
        this._events.set(IncomingHeader.AVISO_GLOBAL_SUBASTA, AvisoGlobalSubastaEvent);
 this._events.set(IncomingHeader.ESTADO_SUBASTA, EstadoSubastaEvent);
        ...
        // ROOM EVENTS
        this._events.set(IncomingHeader.COMBAT_GRID, CombatGridEvent);
        ...
        this._events.set(IncomingHeader.HISTORIAL_SUBASTAS, HistorialSubastasEvent);
        this._events.set(IncomingHeader.FEED_SUBASTAS, FeedSubastasEvent);
    ...
    private registerComposers(): void {
        ...
        this._composers.set(OutgoingHeader.CONSULTAR_BLOQUEO_INVENTARIO, ConsultarBloqueoInventarioComposer);
        ...
        this._composers.set(OutgoingHeader.OBTENER_INVENTARIO_SUBASTAS, ObtenerInventarioSubastasComposer);
        this._composers.set(OutgoingHeader.PONER_EN_SUBASTA, PonerEnSubastaComposer);
        this._composers.set(OutgoingHeader.OBTENER_MIS_SUBASTAS, ObtenerMisSubastasComposer);
        this._composers.set(OutgoingHeader.RETIRAR_SUBASTA, RetirarSubastaComposer);
        this._composers.set(OutgoingHeader.PUJAR_SUBASTA, PujarSubastaComposer);
        this._composers.set(OutgoingHeader.OBTENER_ESTADO_SESION_SUBASTAS, ObtenerEstadoSesionSubastasComposer);
        ...
        this._composers.set(OutgoingHeader.OBTENER_HISTORIAL_SUBASTAS, ObtenerHistorialSubastasComposer);
        this._composers.set(OutgoingHeader.OBTENER_FEED_SUBASTAS, ObtenerFeedSubastasComposer);
