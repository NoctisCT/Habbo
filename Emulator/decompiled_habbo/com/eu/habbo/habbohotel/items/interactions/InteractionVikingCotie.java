...
extends InteractionDefault {
    ...
    public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
        ...
        if (client != null && client.getHabbo().getHabboInfo().getId() == this.getUserId() && (client.getHabbo().getRoomUnit().getEffectId() == 172 || client.getHabbo().getRoomUnit().getEffectId() == 173) && (state = Integer.parseInt(this.getExtradata())) < 5) {
