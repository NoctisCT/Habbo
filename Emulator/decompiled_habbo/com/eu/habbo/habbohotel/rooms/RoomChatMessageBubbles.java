...
public enum RoomChatMessageBubbles {
    ...
    private RoomChatMessageBubbles(int type, String permission, boolean overridable, boolean triggersTalkingFurniture) {
        this.type = type;
    ...
    public static RoomChatMessageBubbles getBubble(int bubbleId) {
        try {
            return RoomChatMessageBubbles.values()[bubbleId];
        }
        catch (Exception e) {
            return NORMAL;
        }
