...
public class RoomUnit {
    ...
    private boolean isGameSnow = false;
    ...
    public boolean cycle(Room room) {
        try {
            ...
            Deque<RoomTile> peekPath;
            RoomTile next;
            boolean overrideChecks;
            Habbo rider;
            Pet pet;
            if (this.getRoomUnitType() == RoomUnitType.PET && (pet = room.getPet(this)) instanceof RideablePet && (rider = ((RideablePet)pet).getRider()) != null) {
            ...
            if (this.status.remove((Object)RoomUnitStatus.SNOWWAR_RUN) != null) {
                this.statusUpdate = true;
            }
            if (this.status.remove((Object)RoomUnitStatus.LAY) != null) {
                this.statusUpdate = true;
            }
            if (this.status.remove((Object)RoomUnitStatus.SNOWWAR_PICK) != null) {
                this.statusUpdate = true;
            }
            if (this.status.remove((Object)RoomUnitStatus.SNOWWAR_DIE_BACK) != null) {
                this.statusUpdate = true;
            }
            if (this.status.remove((Object)RoomUnitStatus.SNOWWAR_DIE_FRONT) != null) {
                this.statusUpdate = true;
            }
            ...
            if ((peekPath = room.getLayout().findPath(this.currentLocation, this.path.peek(), this.goalLocation, this)) == null) {
                peekPath = new LinkedList<RoomTile>();
            }
            if (peekPath.size() >= 3) {
                if (this.path.isEmpty()) {
                    return true;
                ...
                if (peekPath.peek() != next) {
                    next = peekPath.poll();
                    for (int i2 = 0; i2 < peekPath.size(); ++i2) {
            ...
            if ((canSitNextTile = room.canSitAt(next.x, next.y)) && (tallestChair = room.getTallestChair(next)) != null) {
                item = tallestChair;
            }
            ...
            if ((stackHelper = this.room.getItemsAt(next).stream().filter(i -> i instanceof InteractionTileWalkMagic).findAny()).isPresent()) {
            ...
            if (this.getStatusMap().containsKey((Object)RoomUnitStatus.SNOWWAR_RUN)) {
    ...
    public void findPath() {
        Deque<RoomTile> path;
        if (this.room != null && this.room.getLayout() != null && this.goalLocation != null && (this.goalLocation.isWalkable() || this.room.canSitOrLayAt(this.goalLocation.x, this.goalLocation.y) || this.canOverrideTile(this.goalLocation)) && (path = this.room.getLayout().findPath(this.currentLocation, this.goalLocation, this.goalLocation, this)) != null) {
            this.path = path;
        }
    }
    ...
    public void lookAtPoint(RoomTile location) {
        ...
        if (this.status.containsKey((Object)RoomUnitStatus.SNOWWAR_DIE_BACK) || this.status.containsKey((Object)RoomUnitStatus.SNOWWAR_DIE_FRONT)) {
            return;
        }
        if (this.status.containsKey((Object)RoomUnitStatus.SNOWWAR_PICK)) {
            return;
        }
    ...
    public boolean getIsGameSnow() {
        return this.isGameSnow;
    }

    public void setGameSnow(boolean gameSnow) {
        this.isGameSnow = gameSnow;
    }
}
