...
public class CustomCombatLookEvent extends RoomUserLookAtPoint {
    @Override
    public void handle() throws Exception {
        ...
        // Guardamos el índice del buffer por si el jugador solo quiere mirar normal
        buf.markReaderIndex();
        ...
        if (CombatListener.isAttacking(habbo)) {
            ...
            if (Math.abs(curX - clickX) > 1 || Math.abs(curY - clickY) > 1) {
                ...
                return; // Bloqueamos la acción pero NO consumimos el modo ataque (mantiene el turno)
            }
            ...
            // Cortamos el flujo aquí. No abrimos el menú de Habbo del rival ni giramos el
            // personaje.
            return;
        }

        // Si no estaba atacando, reseteamos el lector al inicio y dejamos que Arcturus
        // procese el giro normal
